...
export const getStaticPaths: GetStaticPaths = async (context) => {
  ...
  if (process.env.NODE_ENV !== 'development' && scConfig.generateStaticPaths) {
    try {
      ...
      localDebug.gpn.error('Error occurred while fetching static paths: %o', error);
    }
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  return {
    ...
    revalidate: !page ? 5 : parseInt(process.env.STATIC_GENERATION_TTL ?? '5'),
    notFound: !page, // Returns custom 404 page with a status code of 404 when true
  };
};
